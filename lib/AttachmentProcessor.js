...
const ATTACHMENT_STORAGE_SERVICE_BASE_URL = process.env.ATTACHMENT_STORAGE_SERVICE_BASE_URL || 'http://attachment-storage-service.oih-prod-ns.svc.cluster.local:3002';
